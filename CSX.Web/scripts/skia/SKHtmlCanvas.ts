...
//		public static initGL(elementId: string, callback: DotNet.DotNetObjectReference): SKGLViewInfo {
//			var view = SKHtmlCanvas.init(true, elementId, callback);
//			if (!view || !view.glInfo)
//				return null;
...
//		public static initRaster(elementId: string, callback: DotNet.DotNetObjectReference): boolean {
//			var view = SKHtmlCanvas.init(false, elementId, callback);
//			if (!view)
//				return false;
...
//		static init(useGL: boolean, elementId: string, callback: DotNet.DotNetObjectReference): SKHtmlCanvas {
...
//			const view = new SKHtmlCanvas(useGL, htmlCanvas, callback);
