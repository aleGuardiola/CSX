...
namespace CSX.NativeComponents
{
    ...
    public record ImageProps(ImageSource Source) : ViewProps<ImageStyleProps>
    {
    ...
    public class Image : DOMComponent<ImageProps>
    {
        ...
        IEnumerable<(string Name, string? Value)> GetPropertiesWithValues()
        {
            ...
            // image styles
            yield return ($"Style.{nameof(ImageStyleProps.ResizeMode)}", Props.Style?.ResizeMode?.ToString());
        }
